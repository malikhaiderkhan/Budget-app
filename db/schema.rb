...
ActiveRecord::Schema[7.1].define(version: 2023_12_02_194637) do
  ...
  create_table "category_transactions", force: :cascade do |t|
    ...
    t.index ["money_transaction_id"], name: "index_category_transactions_on_money_transaction_id"
  end
  ...
  add_foreign_key "category_transactions", "money_transactions"
